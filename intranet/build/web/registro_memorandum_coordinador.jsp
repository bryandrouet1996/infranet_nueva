                            ...
                            <div class="row">
                                <div class="col-12 col-md-6 col-lg-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <%if (id_memorandum == 0) {%>
                                            <form class="needs-validation" id="formRegistroMemorandumCoordinador" action="memorandum.ct?opcion=registro" method="post" enctype="multipart/form-data">
                                                <div class="card-body">
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            <label>Adjunto</label>
                                                            <input type="file" class="form-control" name="txtadjunto" id="txtadjunto" onchange="validateSize()">
                                                        </div>
